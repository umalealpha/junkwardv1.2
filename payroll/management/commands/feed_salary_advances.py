"""payroll/management/commands/feed_salary_advances.py - Early Salary Advance recovery (Build Spec B12, marker AUTO-ADVANCE).

Usage:  python manage.py feed_salary_advances --period 2026-10 [--company ADIC] [--dry-run]
...
class Command(BaseCommand):
    help = "Recover CFO-approved salary advances in full on this period's payslips."
    ...
    def handle(self, *args, **opts):
        ...
        from payroll.salary_advance_service import feed_period
